...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk_pin }];#set
...
## LEDs
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { hsync }]; #IO_L6N_T0_VREF_34 Sch=LED0
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { vsync }]; #IO_L6P_T0_34 Sch=LED1
...
## Buttons
#set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { rst_pin }]; #IO_L4P_T0_35 Sch=BTN0
